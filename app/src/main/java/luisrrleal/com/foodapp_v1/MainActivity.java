...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragmentX_demo, home_fragment).commit();
        mainNav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if(item.getItemId()==R.id.nav_home){
                    ...
                    getSupportFragmentManager().beginTransaction().replace(R.id.fragmentX_demo, cart_fragment).commit();
                    //loadFragment(Cart_Fragment.newInstance());
                }else if(item.getItemId()==R.id.nav_profile){
                    getSupportFragmentManager().beginTransaction().replace(R.id.fragmentX_demo, profile_fragment).commit();
                    //loadFragment(Profile_Fragment.newInstance());
                }else if(item.getItemId()==R.id.nav_help){
                    getSupportFragmentManager().beginTransaction().replace(R.id.fragmentX_demo, help_fragment).commit();
